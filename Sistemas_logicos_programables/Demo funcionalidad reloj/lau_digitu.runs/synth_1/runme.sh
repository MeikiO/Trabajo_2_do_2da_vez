...
HD_PWD='C:/Users/mikel/Desktop/proyecto/producto/Vivado/lau_digitu/lau_digitu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nagusia.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nagusia.tcl

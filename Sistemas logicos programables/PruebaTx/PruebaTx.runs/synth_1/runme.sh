...
HD_PWD='C:/Users/mikel/Desktop/proyecto/producto/Sistemas logicos programables/PruebaTx/PruebaTx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProFit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProFit.tcl

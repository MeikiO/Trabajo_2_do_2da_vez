...
HD_PWD='C:/Users/mikel/Desktop/proyecto/producto/Sistemas logicos programables/PruebaTx/PruebaTx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ProFit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ProFit.tcl -notrace

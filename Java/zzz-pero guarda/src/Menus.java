...
//        Game juegoDePrueba = new Game();
//        juegoDePrueba.setTag(PGN.TAG_EVENT, "Una partida de pruebas");
//        juegoDePrueba.setTag(PGN.TAG_SITE, "Pruebilandia");
//        Calendar calendario = Calendar.getInstance();
//        calendario.set(2020, 12, 22);
//        juegoDePrueba.setTag(PGN.TAG_DATE,
//        PGN.dateToPGNDate(calendario.getTime()));
//        juegoDePrueba.setTag(PGN.TAG_ROUND, "?!?");
//        juegoDePrueba.setTag(PGN.TAG_WHITE, "Benzirpi Mirvento");
//        juegoDePrueba.setTag(PGN.TAG_BLACK, "Eloiza Batiati");
//        GameModel modeloDelJuegoDePrueba = juegoDePrueba.getModel();
//
//        FileWriter escritor = null;
//        try {
//            File archivo = new File("C:\\Users\\Juan\\Documents\\a_TEMP\\GuardadoDesdeJuegoDePruebas.pgn");
//            escritor = new FileWriter(archivo);
//// escritor.write("Hola, mundo.");
//            PGNWriter escritorPGN = new PGNWriter(escritor);
//            escritorPGN.write(modeloDelJuegoDePrueba);

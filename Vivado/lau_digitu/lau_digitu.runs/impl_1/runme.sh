...
HD_PWD='C:/Users/mikel/Desktop/proyecto/producto/Vivado/lau_digitu/lau_digitu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nagusia.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nagusia.tcl -notrace
